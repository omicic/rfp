...
import rfp.loyality.config.audit.AuditEventConverter;
import rfp.loyality.domain.PersistentAuditEvent;
...
import static rfp.loyality.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
